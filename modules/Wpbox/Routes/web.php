...
Route::middleware('check.token')->post('/send-template-message', [APIController::class, 'sendTemplateMessageToPhoneNumber']);
...
Route::prefix('wpbox')->group(function() {
    ...
    Route::group([
        ...
        Route::post('/test-json', function () {
            return response()->json(['success' => true, 'message' => 'Route is working!']);
        });
